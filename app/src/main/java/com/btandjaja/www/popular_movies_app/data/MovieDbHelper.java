...
public class MovieDbHelper extends SQLiteOpenHelper {
    ...
    /* additional column */
    private static final String NEW_COLUMN = MovieEntry.COLUMN_NAME_MOVIE_ID;
     ...
     *  COLUMN_NAME_MOVIE_ID is column 7
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        final String SQL_CREATE_MOVIE_LIST_TABLE = "CREATE TABLE " +
                ...
                MovieEntry.COLUMN_NAME_MOVIE_ID + " INTEGER NOT NULL" +
                ");";
